...
head -n 1 data/result_clades_and_metadata.csv > data/result_omicron_metadata.csv
grep "(Omicron)" data/result_clades_and_metadata.csv >> data/result_omicron_metadata.csv